...
public interface CoursePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PROGRAM_YEAR__SPECIALIZATIONS = 0;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION__STARTING_YEAR = 1;
	...
	/**
	 * The meta object id for the '{@link course.impl.SpecializationSemesterImpl <em>Specialization Semester</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see course.impl.SpecializationSemesterImpl
	 * @see course.impl.CoursePackageImpl#getSpecializationSemester()
	 * @generated
	 */
	int SPECIALIZATION_SEMESTER = 9;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER__YEAR = SEMESTER__YEAR;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER__SEMESTER_TYPE = SEMESTER__SEMESTER_TYPE;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER__TEACHED_IN_SEMESTER = SEMESTER__TEACHED_IN_SEMESTER;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER__MANDATORY_COURSES = SEMESTER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER__OPTIONAL_COURSES = SEMESTER_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Specialization Semester</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER_FEATURE_COUNT = SEMESTER_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Specialization Semester</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIALIZATION_SEMESTER_OPERATION_COUNT = SEMESTER_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference '{@link course.Specialization#getStartingYear <em>Starting Year</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Starting Year</em>'.
	 * @see course.Specialization#getStartingYear()
	 * @see #getSpecialization()
	 * @generated
	 */
	EReference getSpecialization_StartingYear();
	...
	/**
	 * Returns the meta object for class '{@link course.SpecializationSemester <em>Specialization Semester</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Specialization Semester</em>'.
	 * @see course.SpecializationSemester
	 * @generated
	 */
	EClass getSpecializationSemester();

	/**
	 * Returns the meta object for the containment reference list '{@link course.SpecializationSemester#getMandatoryCourses <em>Mandatory Courses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Mandatory Courses</em>'.
	 * @see course.SpecializationSemester#getMandatoryCourses()
	 * @see #getSpecializationSemester()
	 * @generated
	 */
	EReference getSpecializationSemester_MandatoryCourses();

	/**
	 * Returns the meta object for the containment reference list '{@link course.SpecializationSemester#getOptionalCourses <em>Optional Courses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Optional Courses</em>'.
	 * @see course.SpecializationSemester#getOptionalCourses()
	 * @see #getSpecializationSemester()
	 * @generated
	 */
	EReference getSpecializationSemester_OptionalCourses();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference SPECIALIZATION__STARTING_YEAR = eINSTANCE.getSpecialization_StartingYear();
		...
		/**
		 * The meta object literal for the '{@link course.impl.SpecializationSemesterImpl <em>Specialization Semester</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see course.impl.SpecializationSemesterImpl
		 * @see course.impl.CoursePackageImpl#getSpecializationSemester()
		 * @generated
		 */
		EClass SPECIALIZATION_SEMESTER = eINSTANCE.getSpecializationSemester();
		 ...
		 * @generated
		 */
		EReference SPECIALIZATION_SEMESTER__MANDATORY_COURSES = eINSTANCE.getSpecializationSemester_MandatoryCourses();
		 ...
		 * @generated
		 */
		EReference SPECIALIZATION_SEMESTER__OPTIONAL_COURSES = eINSTANCE.getSpecializationSemester_OptionalCourses();
