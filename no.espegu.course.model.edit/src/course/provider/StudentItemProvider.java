...
/**
 * This is the item provider adapter for a {@link course.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_studyPlan_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_studyPlan_feature", "_UI_Student_type"),
				 CoursePackage.Literals.STUDENT__STUDY_PLAN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoursePackage.Literals.STUDENT__NAME,
				 true,
				 false,
				 false,
