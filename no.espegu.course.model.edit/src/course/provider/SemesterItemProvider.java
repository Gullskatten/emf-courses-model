...
/**
 * This is the item provider adapter for a {@link course.Semester} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemesterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semester_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semester_type_feature", "_UI_Semester_type"),
				 CoursePackage.Literals.SEMESTER__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoursePackage.Literals.SEMESTER__YEAR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		SemesterType labelValue = ((Semester)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Semester.class)) {
			case CoursePackage.SEMESTER__TYPE:
