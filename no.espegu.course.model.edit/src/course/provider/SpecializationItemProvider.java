...
/**
 * This is the item provider adapter for a {@link course.Specialization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecializationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoursePackage.Literals.SPECIALIZATION__PROGRAM,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoursePackage.Literals.SPECIALIZATION__SEMESTERS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Specialization_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.SPECIALIZATION__SEMESTERS,
				 CourseFactory.eINSTANCE.createSpecializationSemester()));
	}
