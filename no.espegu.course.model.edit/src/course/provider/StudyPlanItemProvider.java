...
/**
 * This is the item provider adapter for a {@link course.StudyPlan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudyPlanItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StudyPlan_specialization_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StudyPlan_specialization_feature", "_UI_StudyPlan_type"),
				 CoursePackage.Literals.STUDY_PLAN__SPECIALIZATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoursePackage.Literals.STUDY_PLAN__SEMESTERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.STUDY_PLAN__SEMESTERS,
				 CourseFactory.eINSTANCE.createStudyPlanSemester()));
	}
